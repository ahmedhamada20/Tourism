...
@section('title', 'Edit privacyPolicy')
@section('css')
@endsection
@section('content')
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h4 class="page-title m-0">Edit privacyPolicy</h4>
                    </div>
                    <!-- end col -->
                </div>
                <!-- end row -->
    ...
    <div class="row">
        <div class="col">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('privacyPolicy.update','test')}}" method="post" enctype="multipart/form-data">
                      @method('PUT')
                        @csrf
                        ...
                        @if($data->photo)
                            <img src="{{asset('admin/pictures/privacyPolicy/' . $data->id .'/' .$data->photo->Filename)}}" width="50" height="50" class="rounded-circle" alt="...">
                        @endif
