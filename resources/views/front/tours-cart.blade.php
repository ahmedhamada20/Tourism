                        ...
                        <tbody>
                            <tr class="product-row">
                             ...
                             <td>
                                ...
                                <td>{{ $trip->price_adult_EN + Cart::subtotal()}}</td>
                            </tr>
                        </tbody>
                    </table>
                    <hr>
            ...
            <div class="col-lg-4">
                <div class="cart-summary">
                    ...
                    <div class="checkout-methods">
                        <a href="{{ route('user_trips_info',encrypt($trip->id)) }}" class="btn btn-block btn-sm btn-primary">{{trans('app.checkout')}}</a>
                    </div>
                </div>
            </div>
        </div>
